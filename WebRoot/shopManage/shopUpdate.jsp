...
<html>
      ...
      <script type="text/javascript">
        $(function(){ 
            $("#confirmBtn").click(function(){
              var url = "shopManage!modifyUpdate?id="+$("[name='id']").val()+"&name="+$("#name").val()+"&person="+$("#person").val()+"&addr="+$("#addr").val()+"&phone="+$("#phone").val();
  ...
  <body>
    ...
    <div id="prodContainer" >
        ...
        <form class="form-horizontal" action="shopManage!modifyUpdate"  type="post">
